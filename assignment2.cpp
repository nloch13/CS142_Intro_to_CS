...
int main () {
	...
	cout<<"------------------------"<<endl;
	cout<<"Nate's Temperature Converter"<<endl;
	int tempFahr; 
	cout<<"Please enter today's temperature in degrees Fahrenheit:"<<endl;
	cin>> tempFahr;
	int tempCels = (tempFahr - 32) * 5/9;
	cout<<"Today's temperature in degrees Celsius is: "<<tempCels<<" degrees Celsius"<<endl;
	cout<<"------------------------"<<endl;
